...
<head>
    ...
    <title>{{ __('messages.sign_in') }} | {{config('settings.system_title')}}</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <a href="{{ url('/password/reset') }}">{{ __('messages.i_forgot_my_password') }}</a><br>
        {{--<a href="{{ url('/register') }}" class="text-center">{{ __('messages.register_a_new_membership') }}</a>--}}

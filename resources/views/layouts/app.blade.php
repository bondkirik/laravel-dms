...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/lte/skins/skin-green.min.css')}}">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{route('admin.dashboard')}}" class="hidden-xs logo">
                <span class="logo-mini"><b>DMS{{--config('settings.system_title')[0]--}}</b></span>
                <span class="logo-lg"><b>DMS{{--config('settings.system_title')--}}</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown tasks-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">You have 3 new docs</li>
                                <li>
                                        ...
                                        @foreach ([1,2,3] as $activity)
                                                <li><!-- Task item -->
                                                    <a href="#">
                                                        <h3>
                                                            {{'Doc 1 uploaded'}}
                                                            <small class="pull-right">{{formatDateTime('2020.11.20 13:13')}}</small>
                                                        </h3>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        {!! Auth::user()->name !!}
                                        <small>{{ __('messages.member_since') }} {!! Auth::user()->created_at->format('M. Y') !!}</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{route('profile.manage')}}" class="btn btn-default btn-flat">{{ __('messages.profile') }}</a>
                                    </div>
